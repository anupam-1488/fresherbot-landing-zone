...
const Navbar = () => {
  ...
  return (
    <motion.nav 
      ...
      className="w-full py-3 fixed top-0 left-0 right-0 z-50 shadow-sm" 
      style={{ backgroundColor: "#E0EDF4" }}
    >
            ...
            <>
              ...
              {menuOpen && (
                <motion.div 
                  ...
                  className="absolute top-16 right-0 left-0 shadow-md py-4 px-4 border-t border-gray-100" 
                  style={{ backgroundColor: "#E0EDF4" }}
                >
