    ...
    <section className="w-full overflow-hidden">
      ...
      <div className="h-screen w-full relative">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-burgundy-950/90 to-transparent"></div>
        </div>
        ...
        <div className="relative h-full w-full flex items-center">
          <div className="container mx-auto px-4 md:px-8 flex flex-col lg:flex-row items-center">
            ...
            >
              {/* Task Card */}
              <motion.div 
                className="absolute top-1/3 right-8 bg-white text-gray-900 rounded-lg p-3 shadow-lg max-w-xs z-20"
                animate={{ 
                  x: [0, 5, 0],
                }}
                transition={{ 
      ...
      {/* Stats Section */}
      <div className="bg-beige-50 w-full py-16">
