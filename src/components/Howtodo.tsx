        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="px-3 py-1 bg-gray-50 text-gray-600 rounded-full text-sm font-medium">Pending</span>
            </div>
          </div>
        </div>
      )
  ...
  return (
    <div className="min-h-screen bg-gradient relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 relative z-10">
        <div className="mb-4">
          <span className="inline-block px-4 py-1 bg-green-50 text-green-700 rounded-full text-sm font-medium">
            HOW IT WORKS
          </span>
        </div>
        
        <h1 className="text-5xl title-font mb-16 text-gray-900">
              ...
              <div
                ...
                className={`p-6 rounded-2xl cursor-pointer transition-all ${
                  activeStep === parseInt(step.number) 
                    ...
                    : 'bg-white hover:bg-[#BEB2F3] shadow'
                }`}
            ...
            {steps.map((step) => (
              <div
                ...
                className={`step-content ${
                  activeStep === parseInt(step.number) ? 'visible' : 'hidden'
                }`}
              >
                {activeStep === parseInt(step.number) && step.content}
              </div>
            ))}
          </div>
        </div>
